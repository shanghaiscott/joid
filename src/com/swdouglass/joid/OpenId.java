...
public class OpenId {
  ...
  public boolean canHandle(String query) {
    try {
      MessageFactory.parseRequest(query);
      return true;
    } catch (Exception e) {
      log.info(e, e);
      return false;
  ...
  public boolean isAssociationRequest(String query) {
    try {
      Request req = MessageFactory.parseRequest(query);
  ...
  public String handleRequest(String query) throws OpenIdException {
    Request req = null;
    try {
      req = MessageFactory.parseRequest(query);
    } catch (UnsupportedEncodingException e) {
  ...
  public boolean isAnErrorResponse(String s) {
    try {
      Response resp = MessageFactory.parseResponse(s);
